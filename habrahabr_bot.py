...
telebot.apihelper.proxy = {'https':'socks5://{user}:{password}@{proxy_address}:{port}'.format(user = config.PROXY_USER, password=config.PROXY_PASSWORD, proxy_address=config.PROXY_SERVER, port=config.PROXY_PORT )}
